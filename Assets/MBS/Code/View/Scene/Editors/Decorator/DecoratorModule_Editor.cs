...
namespace MBS.View.Scene
{
    ...
    [CustomEditor( typeof( MBSDecoratorModule ) )]
    public  class DecoratorModule_Editor : Editor
    {
        ...
        private void OnEnable( )
        {
            ...
            {
                _single = (MBSDecoratorModule)target;
            ...
            {
                _multiple = targets.Cast<MBSDecoratorModule>( ).ToArray( );
