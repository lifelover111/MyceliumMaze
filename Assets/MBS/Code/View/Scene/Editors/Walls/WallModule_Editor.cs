...
namespace MBS.View.Scene
{
    ...
    [CustomEditor( typeof( MBSWallModule ) )]
    public  class WallModule_Editor : Editor
    {
        ...
        private void OnEnable( )
        {
            ...
            {
                _multiple = targets.Cast<MBSWallModule>( ).ToArray( );
        ...
        private void ShowMeshModifiersAffectToggles( )
        {
            if ( !_multipleSelection )
            {
                ...
                {
                    _foldoutMeshModifiers = EditorGUILayout.Foldout( _foldoutMeshModifiers, "Children Modification",
        ...
        private static bool AreTwoHaveLockedConnection( MBSWallModule wall1, MBSWallModule wall2 )
        {
